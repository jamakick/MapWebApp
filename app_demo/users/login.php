...
<html lang="en">
	...
	<div>
	<div class="registerForm"><label for="demo-3">Username: </label><input type="text" name="username" required></div>
	<div class="registerForm"><label for="demo-3">Password: </label><input type="password" name="password" required></div>
	<br>
	<div class="ccc-button ccc-button--success registerForm"><input type="submit" value="Submit"></div>
