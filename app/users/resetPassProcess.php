...
$passQuery = mysqli_query($connection, "update users set reset_pin = '$randNum' where
	user_email = '$email'");

mail($email, "Reset Cold Case Connection Password", "Your pin code is: " + $randNum
	, "From: noreply@coldcaseconnection'");
?>
...
<html lang="en">
	...
	<form action="resetPassProcess2.php" method="post">
		<div class="row">
				<div class="three columns"><label for="firstName">Enter pin:</label><input class="u-full-width" type="text" name="pin" required>
