...
<html lang="en">
	...
	<form action="resetPassProcess4.php" method="post">
		<div class="row">
				<div class="three columns"><label for="password">New Password</label><input class="u-full-width" type="password" name="password" required></div>
		</div>
		<div class="row">
					<div class="three columns"><label for="confirmPass">Confirm New Password</label><input class="u-full-width" type="password" name="confirmPass" required>
					<input type="hidden" name="email" value="<?php echo $email;?>">				</div>
		</div>
	<div class="response">
